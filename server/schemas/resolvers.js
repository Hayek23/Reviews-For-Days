...
const resolvers = {
  Query: {
    ...
    me: async (parent, args, context) => {
      if (context.user) {
        return User.findOne({ _id: context.user._id }).populate('bookReviews').populate('movieReviews').populate('gameReviews');
      }
  ...
  Mutation: {
    ...
    addMovieReview: async (parent, { title, reviewText, genre, time }, context) => {
      if (context.user) {
    ...
    addBookReview: async (parent, { title, reviewText, genre, time }, context) => {
      if (context.user) {
    ...
    addGameReview: async (parent, { title, reviewText, genre, time }, context) => {
      if (context.user) {
